                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('user.update', ['id' => $user->id]) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="prefix" id="prefix" class="form-control @error('prefix') is-invalid @enderror">
                                    ...
                                    <option @selected(old('prefix', $additional['prefix']) == 'Mr.')>Mr.</option>
                                    <option @selected(old('prefix', $additional['prefix']) == 'Mrs.')>Mrs.</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname', $additional['firstname']) }}" autocomplete="firstname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="middlename" type="text" class="form-control @error('middlename') is-invalid @enderror" name="middlename" value="{{ old('middlename', $additional['middlename']) }}" autocomplete="middlename" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname', $additional['lastname']) }}" autocomplete="lastname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="suffixname" id="suffixname" class="form-control @error('suffixname') is-invalid @enderror">
                                    ...
                                    <option @selected(old('suffixname', $additional['suffix']) == 'Jr')>Jr</option>
                                    <option @selected(old('suffixname', $additional['suffix']) == 'II')>II</option>
                                    <option @selected(old('suffixname', $additional['suffix']) == 'III')>III</option>
                                    <option @selected(old('suffixname', $additional['suffix']) == 'IV')>IV</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="url" class="form-control @error('photo') is-invalid @enderror" name="photo" value="{{ old('photo',$additional['avatar']) }}" autocomplete="photo">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a class="btn btn-danger m-1" href="{{route('user.index')}}">Back</a>
                            </div>
                        </div>
                    </form>
                </div>
